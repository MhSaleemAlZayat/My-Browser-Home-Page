  ...
  },
  {
    ...
    websites: [
      ...
      },
      {
        ...
        icon: "netflix-inspired-logo.png",
  ...
  return `
        <div class="website-card" data-url="${website.url}">
            <div class="website-icon">
                <img src="${website.icon}" alt="${website.name} icon" onerror="this.src='generic-website-icon.png'">
            </div>
